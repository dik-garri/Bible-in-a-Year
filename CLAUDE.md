...
- Full Bible search (🔍 button or Ctrl+F): loads full translation file (~6MB, cached), 3 tiers: exact phrase → all words → partial; click result to open chapter with auto-scroll to verse
